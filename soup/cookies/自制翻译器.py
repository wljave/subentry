...
class YouDaoFanyi(object):
    ...
    def crawl(self, words):
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
                          'Chrome/87.0.4280.88 Safari/537.36 ',
        }
        # 设置代理IP
        proxy = '220.174.236.211:8091'
        ...
        data = {
            ...
            'client': 'fanyideskweb',
            'salt': '16097236646203',
            'sign': 'ba791afbba4ee7cc0dd68a9bb0397d41',
            'lts': '1609723664620',
...
# Python GUI编程(Tkinter)     学习网址：https://www.runoob.com/python/python-gui-tkinter.html
