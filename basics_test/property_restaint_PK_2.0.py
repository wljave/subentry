...
# assassin = Assassin()
# bowman = Bowman()
# # print(role.name + '的血量是' + str(role.life) + '；攻击力是' + str(role.attack))
# # print(knight.name + '的血量是' + str(knight.life) + '；攻击力是' + str(knight.attack))
# # print(assassin.name + '的血量是' + str(assassin.life) + '；攻击力是' + str(assassin.attack))
# # print(bowman.name + '的血量是' + str(bowman.life) + '；攻击力是' + str(bowman.attack))
# order = [role, knight, assassin, bowman]
# for i in order:
